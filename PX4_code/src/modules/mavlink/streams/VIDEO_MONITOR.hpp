...
#include "../../../../mavlink/include/mavlink/v2.0/video_monitor/mavlink_msg_video_monitor.h"
...
//	PX4_INFO("Start of sending the message :)");
        struct video_monitor_s _video_monitor;  //make sure video_monitor_s is the TEST HIERO
...
//		PX4_INFO("Sending in if loop!");
	        ...
	        mavlink_msg_video_monitor_send_struct(_mavlink->get_channel(),
	                                              &_msg_video_monitor);
//		if((double)_video_monitor.confidence > 0.9999)
