...
//	for(int i = 0; i < 20; i++) {
		...
		videoMon.lat = rand() % 50;
		videoMon.lon = 12345678;
		videoMon.no_people = videoMon.lat + 5;
...
extern "C" __EXPORT int video_monitor_back_main(int argc, char *argv[]);
int video_monitor_back_main(int argc, char *argv[]) {
